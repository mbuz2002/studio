      ...
      <Card className="shadow-xl rounded-lg">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-primary-foreground/90 mt-1">
                Lihat dan kelola semua pengguna di seluruh sekolah. (Fitur Mendatang)
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="pt-6 p-4 md:p-6">
          <p className="text-muted-foreground">
            Halaman ini akan memungkinkan Super Admin untuk melihat daftar semua pengguna dari semua sekolah,
            mengubah peran global jika diperlukan, dan menonaktifkan akun secara global. Fitur ini sedang dalam pengembangan.
          </p>
        </CardContent>
      </Card>
    </div>
