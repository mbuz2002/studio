...
import { useAuth } from '@/contexts/AuthContext'; // Import useAuth to respect roles if needed

interface MobileNavItemData {
  href: string;
  label: string;
  icon: React.ElementType;
  roles?: UserRole[]; // Optional: for role-based visibility
}

// Define the specific items for the bottom nav as per the request
